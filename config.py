...
_FALLBACK_AGENT_DEFAULTS = {
    ...
    "AGENT_OPTICAL_FLOW_OVERLAY":    False,
}
...
_pork_defaults = get_agent_defaults("pork_weighing")

AGENT_PHASE1_MODEL_NAME       = _pork_defaults.get("AGENT_PHASE1_MODEL_NAME")
AGENT_PHASE2_MODEL_NAME       = _pork_defaults.get("AGENT_PHASE2_MODEL_NAME")
AGENT_FPS                     = _pork_defaults.get("AGENT_FPS")
AGENT_CONFIDENCE_THRESHOLD    = _pork_defaults.get("AGENT_CONFIDENCE_THRESHOLD")
AGENT_MAX_BATCH_SIZE_MB       = _pork_defaults.get("AGENT_MAX_BATCH_SIZE_MB")
AGENT_CLIP_BUFFER_SECONDS     = _pork_defaults.get("AGENT_CLIP_BUFFER_SECONDS")
AGENT_MAX_FRAMES_PER_BATCH    = _pork_defaults.get("AGENT_MAX_FRAMES_PER_BATCH")
AGENT_BATCH_OVERLAP_FRAMES    = _pork_defaults.get("AGENT_BATCH_OVERLAP_FRAMES")
AGENT_IMAGE_QUALITY           = _pork_defaults.get("AGENT_IMAGE_QUALITY")
AGENT_IMAGE_UPSCALE_FACTOR    = _pork_defaults.get("AGENT_IMAGE_UPSCALE_FACTOR")
AGENT_IMAGE_TARGET_RESOLUTION = _pork_defaults.get("AGENT_IMAGE_TARGET_RESOLUTION")
AGENT_IMAGE_FORMAT            = _pork_defaults.get("AGENT_IMAGE_FORMAT")
AGENT_PHASE2_IMAGE_FORMAT     = _pork_defaults.get("AGENT_PHASE2_IMAGE_FORMAT")
AGENT_IMAGE_INTERPOLATION     = _pork_defaults.get("AGENT_IMAGE_INTERPOLATION")
AGENT_ENABLE_CROPPING         = _pork_defaults.get("AGENT_ENABLE_CROPPING")
AGENT_ROTATION_ANGLE          = _pork_defaults.get("AGENT_ROTATION_ANGLE")

# Fallback specifically for any missing keys in the loaded module
for _k, _v in _FALLBACK_AGENT_DEFAULTS.items():
    if globals().get(_k) is None:
        globals()[_k] = _v
