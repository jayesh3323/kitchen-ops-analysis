    ...
    try:
        ...
        for batch_info in token_usage.get("phase1_batches", []):
            session.add(TokenUsage(
                ...
                cached_tokens=batch_info.get("cached_tokens", 0),
                image_input_tokens=batch_info.get("image_input_tokens", 0),
                text_input_tokens=batch_info.get("text_input_tokens", 0),
                text_output_tokens=batch_info.get("text_output_tokens", 0),
                input_cost_usd=batch_info.get("input_cost_usd", 0.0),
                output_cost_usd=batch_info.get("output_cost_usd", 0.0),
                cost_usd=batch_info.get("cost_usd", 0.0),
            ))
        ...
        for clip_info in token_usage.get("phase2_clips", []):
            session.add(TokenUsage(
                ...
                cached_tokens=clip_info.get("cached_tokens", 0),
                image_input_tokens=clip_info.get("image_input_tokens", 0),
                text_input_tokens=clip_info.get("text_input_tokens", 0),
                text_output_tokens=clip_info.get("text_output_tokens", 0),
                input_cost_usd=clip_info.get("input_cost_usd", 0.0),
                output_cost_usd=clip_info.get("output_cost_usd", 0.0),
                cost_usd=clip_info.get("cost_usd", 0.0),
            ))

        for dd_info in token_usage.get("display_detection", []):
            session.add(TokenUsage(
                job_id=job_id,
                phase="display_detection",
                model=dd_info.get("model"),
                batch_or_clip_id=None,
                prompt_tokens=dd_info.get("prompt_tokens", 0),
                completion_tokens=dd_info.get("completion_tokens", 0),
                total_tokens=dd_info.get("total_tokens", 0),
                cached_tokens=dd_info.get("cached_tokens", 0),
                image_input_tokens=dd_info.get("image_input_tokens", 0),
                text_input_tokens=dd_info.get("text_input_tokens", 0),
                text_output_tokens=dd_info.get("text_output_tokens", 0),
                input_cost_usd=dd_info.get("input_cost_usd", 0.0),
                output_cost_usd=dd_info.get("output_cost_usd", 0.0),
                cost_usd=dd_info.get("cost_usd", 0.0),
            ))
        ...
        _update_job(session, job_id,
                    ...
                    total_cost_usd=round(results.get("total_cost_usd", 0.0), 6),
